...
<!--	 <div class="form-group">
     	<label class="col-md-2 control-label" >{{Netatmo Weather}}</label>
        	<div class="col-md-1" style="width: 4%;">
            	<input type="checkbox" class="configKey" data-l1key="netatmo_weather" />
            </div>
            <span >(A cocher si vous utiliser le plugin officiel Netatmo)</span>			     
     </div> -->
